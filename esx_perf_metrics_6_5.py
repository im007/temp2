...
class VSphereMetrics():
    ...
    def __init__(self, init_config, instance):
        ...
        if init_config['CONFIG']['SSL_VERIFY'] =! None:
            self.ssl_verify = init_config['CONFIG']['SSL_VERIFY']
        else:
            self.ssl_verify = 'False'

        if init_config['CONFIG']['SSL_CAPATH'] =! None:
